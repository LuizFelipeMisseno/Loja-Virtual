...
class _TestLoginState extends State<TestLogin> with TickerProviderStateMixin {
  ...
  double? bodyHeight;
  double? headerHeight;
  RichText changeToRegister = RichText(
    text: TextSpan(
  ...
  RichText changeToLogin = RichText(
    text: TextSpan(
      style: GoogleFonts.poppins(
        color: Colors.black,
        fontStyle: FontStyle.normal,
    ...
    setState(
      () {
        ...
        if (isLogin) {
          ...
          headerPhrase = '';
          actionButton = 'Entrar';
          toggleButton = changeToRegister;
          headerInstruction = 'Entre com sua conta';
          _selectedIndex = 0;
          if (bodyHeight != null) {
            bodyHeight = MediaQuery.of(context).size.height * 0.50;
            headerHeight = MediaQuery.of(context).size.height * 0.50;
          }
        } else {
          title = 'Bem vindo';
          headerPhrase = 'Novo por aqui? É um prazer recebê-lo';
          actionButton = 'Criar conta';
          toggleButton = changeToLogin;
          headerInstruction = 'Informações para a conta';
          _selectedIndex = 1;
          bodyHeight = MediaQuery.of(context).size.height * 0.70;
  ...
  Widget build(BuildContext context) {
    ...
    bodyHeight ??= screenHeight * .5;
    headerHeight ??= screenHeight * .5;
  ...
  authScreen(screenHeight) {
    List<Widget> _indexedHeader = [
      loginHeader(headerHeight),
      firstRegisterHeader(headerHeight),
      secondRegisterHeader(headerHeight),
    ];

    List<Widget> _indexedBody = [
      loginPage(),
      firstRegisterPage(),
      secondRegisterPage(),
    ];
